...
public class WildcardGenericEmployeeServiceUtil 
{
	...
	public static void insertEmployee(IWildcardGenericEmployeeService empInterf) throws SQLException {
		Employee empl = readEmployee();
			empInterf.insertEmployee(empl);
	}

	public static void findEmployee(IWildcardGenericEmployeeService empInterf) throws SQLException {
	...
	public static void deleteEmployee(IWildcardGenericEmployeeService empInterf) throws SQLException {
	...
	public static void updateEmployee(IWildcardGenericEmployeeService empInterf) throws SQLException {
